...
const getAddressFromCookies = (): FormData => {
  return {
    ...
    country: Cookies.get('country') || countries[1].code,
...
const AddressPage = () => {
  ...
  return (
    <ShopLayout title='Dirección' pageDescription='Confirmar dirección del comprador'>
            ...
            <Controller
              ...
              render={({ field }) => (
                <FormControl fullWidth error={!!errors.country}>
                  ...
                  <Select {...field} label="Country" variant='filled'>
